...
namespace WebApi.Controllers
{
    [Route("api/secure")]
    [ApiController]
    public class DownloadFileForSubmission : ControllerBase
    {
        private readonly ILogger<DownloadFileForSubmission> _logger;
        private readonly IServiceClientFactory _serviceClientFactory;
        public DownloadFileForSubmission(ILogger<DownloadFileForSubmission> logger, IServiceClientFactory serviceClientFactory)
        {
            _logger = logger;
        ...
        [HttpGet("DownloadFileForSubmission")]
        [SwaggerOperation(Summary = "Download File For Submission via File ID", Description = "Download File For Submission via File ID")]
        public async Task<IActionResult> DownloadFileSubmission([FromQuery, Required] Guid idSubmission, [FromQuery, Required] Guid idFile)
        {
            try
            {
                ...
                {            
                    ...
                    Entity fileResult = await serviceClient.RetrieveAsync("desnz_submissiondiagramsfiles", idFile, new ColumnSet("desnz_submissiondiagramsfilesid", "desnz_submission"));
                    ...
                    {
                        Target = new EntityReference("desnz_submissiondiagramsfiles", fileResult.GetAttributeValue<Guid>("desnz_submissiondiagramsfilesid")),
