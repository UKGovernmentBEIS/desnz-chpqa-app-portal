...
#This script updates the CHPQA realm in order to configure brute force.
...
#Configures brute force on CHPQA realm
CONFIG_CHPQA_BRUTE_FORCE=$(curl -s -L -X PUT "$UPDATE_REALM_URL$CHPQA_REALM_NAME" \
