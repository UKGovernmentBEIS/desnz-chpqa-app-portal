...
<@layout.registrationLayout displayRequiredFields=true displayMessage=!messagesPerField.existsError('totp') htmlPageTitle="${msg('loginTotpTitle')}"; section>
    ...
    <#elseif section = "form">
        ...
        <p class="govuk-body">
       To access this service, you must download an authenticator app. 
       The authenticator will generate a 6-digit verification code whenever you sign in to your CHPQA programme account.
        </p>
